...
public class WeatherActivityHappyTest {
    ...
    @Test
    public void weatherActivityHappyTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.current_temp),
                        childAtPosition(
                                allOf(withId(R.id.success_screen)),
                                0),
                        isDisplayed()));
        textView.check(matches(isDisplayed()));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.current_location),
                        childAtPosition(
                                allOf(withId(R.id.success_screen)),
                                1),
                        isDisplayed()));
